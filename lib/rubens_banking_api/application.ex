defmodule RubensBankingApi.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: RubensBankingApi.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    RubensBankingApiWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
